 ...
 */
public class RepresentationClassesPage extends NewTypeWizardPage {
	/**
	 * Constructor
	 * 
	 * @param selection
	 ...
	 */
	public RepresentationClassesPage(ISelection selection) {
		super(CLASS_TYPE, "wizardPage");
		setTitle("Generate Java From REST API Blueprint");
		setDescription("Specify where to generate REST Representation classes");
