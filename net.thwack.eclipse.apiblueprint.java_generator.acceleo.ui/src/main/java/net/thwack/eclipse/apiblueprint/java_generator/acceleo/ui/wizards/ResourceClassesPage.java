 ...
 */
public class ResourceClassesPage extends NewTypeWizardPage {
	/**
	 * Constructor
	 * 
	 * @param selection
	 ...
	 */
	public ResourceClassesPage(ISelection selection) {
		super(CLASS_TYPE, "wizardPage");
		setTitle("Generate Java From REST API Blueprint");
		setDescription("Specify where to generate REST Resource classes");
