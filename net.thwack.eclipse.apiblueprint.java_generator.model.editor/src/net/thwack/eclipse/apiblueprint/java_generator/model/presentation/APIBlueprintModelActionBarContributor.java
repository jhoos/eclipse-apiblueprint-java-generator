...
/**
 * This is the action bar contributor for the APIBlueprintModel model editor.
 * <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class APIBlueprintModelActionBarContributor extends
	 ...
	 * @generated
	 */
	public APIBlueprintModelActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("apiblueprintmodel-settings"));
		toolBarManager.add(new Separator("apiblueprintmodel-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(
				APIBlueprintModelEditorPlugin.INSTANCE
						.getString("_UI_APIBlueprintModelEditor_menu"),
				"net.thwack.eclipse.apiblueprint.java_generator.modelMenuID");
