...
/**
 * <!-- begin-user-doc --> A sample utility for the '<em><b>model</b></em>'
 * package. <!-- end-user-doc -->
 * 
 * @generated
 */
public class APIBlueprintModelExample {
	/**
	...
	public static void main(String[] args) {
		...
		//
		resourceSet.getPackageRegistry().put(APIBlueprintModelPackage.eNS_URI,
				APIBlueprintModelPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI
						.createURI("http:///My.apibmodel"));
				APIBlueprint root = APIBlueprintModelFactory.eINSTANCE
						.createAPIBlueprint();
